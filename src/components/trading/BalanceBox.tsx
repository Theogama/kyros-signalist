  ...
  return (
    <div className="bg-[#0f1629] rounded-xl border border-[#1e2a4a] p-5 shadow-lg">
      ...
      <div className="space-y-4">
        {/* Main Balance */}
        <div className="bg-gradient-to-br from-[#0a0e27] to-[#111827] rounded-lg p-4 border border-[#1e2a4a]">
          <div className="flex items-center justify-between mb-1">
            <span className="text-slate-400 text-sm capitalize">{accountType} Account</span>
            <span className="text-slate-500 text-xs font-mono">
              {accountInfo?.currency || 'USD'}
            </span>
          </div>
          <div className={`text-3xl font-bold font-mono transition-all duration-300 ${
            isAnimating ? (accountType === 'real' ? 'text-emerald-400' : 'text-blue-400') : 'text-white'
          }`}>
            {isConnected ? (
              <>
        ...
        <div className="bg-[#0a0e27] rounded-lg p-4 border border-[#1e2a4a]">
          <div className="flex items-center justify-between mb-2">
            <span className="text-slate-400 text-sm">Session P&L</span>
            {totalProfit !== 0 && (
              isProfitable ? (
